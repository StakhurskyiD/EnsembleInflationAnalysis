...
from src.data.data_preprocessing.column_mappings import monthly_columns_map
...
def load_and_map_monthly_data(file_path: str) -> pd.DataFrame:
    ...
    згідно зі словником monthly_columns_map.
    """
    from src.data.data_preprocessing.column_mappings import monthly_columns_map  # імпорт словника
...
def main():
    ...
    output_path = "../output/processed_monthly_data.csv"
